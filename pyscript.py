...
fps = vcap.get(CAP_PROP_FPS) # change it with your input video fps
width = vcap.get(CAP_PROP_FRAME_WIDTH) # change it with your input video width
height = vcap.get(CAP_PROP_FRAME_HEIGHT) # change it with your input vide height
